...
The problem to be solved is that servers can fail and the system has to be prepared  to when those failures happen. To solve this problem, we need to implement a fault-tolerant system which is reliable to use.
